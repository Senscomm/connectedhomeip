...
// Enable temporary diagnostics for event queue pressure and UDP lambda enqueue failures.
#ifndef CHIP_SENSCOMM_EVENT_QUEUE_DIAGNOSTIC_LOGGING
#define CHIP_SENSCOMM_EVENT_QUEUE_DIAGNOSTIC_LOGGING 1
#endif
